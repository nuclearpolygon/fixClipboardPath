...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/media/white/tmp/n_prudov/git_repositories_testing/fixPathDelimiters/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/media/white/tmp/n_prudov/git_repositories_testing/fixPathDelimiters/venv/bin/deactivate.nu'
